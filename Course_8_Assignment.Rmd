...
Out of sample error rates are measured using the **Accuracy** figure when validating the prediction model developed from the training dataset against the validation dataset. The Random Forest prediction model has a very high accuracy rate of **`r (round(rfcm$overall['Accuracy'], 4))`**. The Decision Tree prediction model has a lower accuracy rate of **`r (round(dtcm$overall['Accuracy'], 4))`**.
