...
This section shall apply the **Random Forest** prediction model to the testing dataset to predict a new **testing$classe_rf** variable for each of the twenty observations in the testing dataset.

```{r random forest test prediction}

#Predict against test dataset
        testing$classe_rf <- predict(rfmodel, testing, type = "class")
        testing$classe_rf
```

As the accuracy of the **Generalised Boosting** prediction model was close to that of the **Random Forest** prediction model, it is worth applying the **Generalised Boosting** prediction model to the testing dataset to predict a new **testing$classe_gbm** variable for each of the twenty observations in the testing dataset. The values for this variable for at least nineteen of the twenty observations in the testing dataset should be the same as those predicted by the **Random Forest** prediction model.

```{r generalised boosting model test prediction}

#Predict against test dataset
        testing$classe_gbm <- predict(gbmodel, testing, type = "raw")
        testing$classe_gbm
```
